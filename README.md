...
Bạn có thể dán rule mới trực tiếp trong giao diện (ô “Quy tắc tùy chỉnh”) hoặc sửa file. Ô này nhận một object, một mảng object, hoặc một lệnh JS kiểu `Rule.special.push({...})`; sau khi lưu hãy tải lại trang để rule được nạp lại từ đầu.
