...
*   **Scribd_Document_Exporter.user.js:** Lưu tài liệu Scribd đang đọc thành TXT và PDF khi có lớp chữ; tài liệu chỉ có ảnh sẽ tự tắt TXT và xuất PDF, kèm tiến độ và nút hủy. Mở trang tài liệu Scribd rồi bấm `Lưu TXT/PDF` ở góc dưới bên phải; [Cài đặt](https://raw.githubusercontent.com/BaoBao666888/Novel-Downloader5/main/tools/Scribd_Document_Exporter.user.js).
