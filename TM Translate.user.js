...
(async function () {
    ...
    /* ================== VERSION ================== */
    const CURRENT_VERSION = '3.5.5.15_beta';
...
### ✨ v3.5.5.14_beta - v3.5.5.15_beta
- v3.5.5.15_beta: Sửa lỗi đọc ảnh bìa trên máy đọc sách.
...
- Import vào Tampermonkey được kiểm tra dung lượng toàn bộ trước khi ghi nên không để lại nửa bộ truyện nếu kho không đủ chỗ; import local lỗi giữa chừng cũng tự dọn dữ liệu đang ghi. Bìa lớn (kể cả bìa EPUB và bìa cũ khi tải) tự giảm tối đa 720×1080 bằng JPEG tương thích máy đọc sách; WebP do bản cũ tạo tự được đổi sang JPEG.
...
- Chuyển kho Thư viện sang API \`GM.*\` bất đồng bộ và tách bìa khỏi index lớn. Bản 3.5.5.14 bổ sung lớp nén vì Tampermonkey vẫn preload storage dù dùng API bất đồng bộ.
