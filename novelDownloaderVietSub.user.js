  ...
  */
    ...
    Rule.special = [
        ...
        { // https://m.shauthor.com
            siteName: '大众文学',
            url: '://m\\.shauthor\\.com/info_[^/]+/$',
            chapterUrl: '://m\\.shauthor\\.com/read_[^/]+/[^/]+(?:_\\d+)?\\.html',
            filter: () => {
                if (window.location.host !== 'm.shauthor.com') return 0;
                if (document.querySelector('div.info_chapters > ul.p2:last-of-type > li > a')) return 1;
                if (document.querySelector('#novelcontent')) return 2;
                return 0;
            },
        ...
        { // https://wxscs.com/book/* ; https://www.wxsck.com/book/*
            siteName: '万象书城',
            filter: () => {
                if (!/^(www\.)?(wxscs|wxsck)\.com$/.test(window.location.host)) return 0;
                if (document.querySelector('#all-chapter > div.panel > div.panel-body > div.row > div.item > a')) return 1;
                if (document.querySelector('#cont-body')) return 2;
                return 0;
            },
