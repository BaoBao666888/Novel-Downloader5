...
; (function () { // eslint-disable-line no-extra-semi
  ...
  */
     ...
     * *** Sử dụng GM_xmlhttpRequest để TRÁNH LỖI CORS ***
     * @param {string} rawHtml - HTML thô của chương
     * @returns {Promise<string|null>} - HTML đã xử lý hoặc null nếu lỗi
     */
    ...
    /**
     * (ĐÃ SỬA LẠI HOÀN TOÀN) Xử lý thẻ <i> bằng cách gửi HTML đến Server API
     * @param {string} rawHtml - HTML thô của chương
     * @param {string} sourceType - Nguồn gốc ('jjwxc', etc. - có thể không cần nữa nếu server tự xử lý)
     * @param {object} chapterContext - Thông tin chương (để log nếu cần)
     * @returns {Promise<string>} - HTML đã sửa (hoặc HTML gốc nếu lỗi)
     */
