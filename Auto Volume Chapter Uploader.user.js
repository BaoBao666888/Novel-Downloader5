// ==UserScript==
// @name         Auto Volume/Chapter Uploader (v0.6)
// @author       QuocBao
// @version      0.6
...
(function () {
    ...
    btn.onclick = async () => {
        ...
        const volumeWrapper = document.querySelector('.volume-wrapper.readonly');
        const btnAddVolume = document.querySelector('[data-action="appendLastVolume"]');
        if (volumeWrapper && btnAddVolume) {
            btnAddVolume.click();
            await new Promise(r => setTimeout(r, 500));
            log('📦 Đã nhấn nút thêm Volume');
        }

        const trueWrapper = document.querySelector('.volume-wrapper');
        if (trueWrapper.classList.contains('readonly')) {
            trueWrapper.classList.remove('readonly');
            log('🔓 Đã bỏ class readonly để có thể thao tác.');
        }
        ...
        input.onchange = async () => {
            ...
            async function startUploading() {
                ...
                // Điền số file
                const numFileInput = document.querySelector('input[name="numFile"]');
                if (numFileInput) {
                ...
                // Tắt autoNumber
                const autoNumberCheckbox = document.querySelector('input[name="autoNumber"]');
